...
public class Position2D implements org.apache.thrift.TBase<Position2D, Position2D._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("Position2D");
  ...
  static {
    schemes.put(StandardScheme.class, new Position2DStandardSchemeFactory());
    schemes.put(TupleScheme.class, new Position2DTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(Position2D.class, metaDataMap);
  }
  ...
  public boolean equals(Object that) {
    ...
    if (that instanceof Position2D)
      return this.equals((Position2D)that);
    return false;
  }
  ...
  public int compareTo(Position2D other) {
    ...
    Position2D typedOther = (Position2D)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("Position2D(");
    boolean first = true;
  ...
  private static class Position2DStandardSchemeFactory implements SchemeFactory {
    public Position2DStandardScheme getScheme() {
      return new Position2DStandardScheme();
    }
  }

  private static class Position2DStandardScheme extends StandardScheme<Position2D> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, Position2D struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Position2D struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class Position2DTupleSchemeFactory implements SchemeFactory {
    public Position2DTupleScheme getScheme() {
      return new Position2DTupleScheme();
    }
  }

  private static class Position2DTupleScheme extends TupleScheme<Position2D> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, Position2D struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, Position2D struct) throws org.apache.thrift.TException {
