...
public class Position3D implements org.apache.thrift.TBase<Position3D, Position3D._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("Position3D");
  ...
  static {
    schemes.put(StandardScheme.class, new Position3DStandardSchemeFactory());
    schemes.put(TupleScheme.class, new Position3DTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(Position3D.class, metaDataMap);
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof Position3D)
      return this.equals((Position3D)that);
    return false;
  }

  public boolean equals(Position3D that) {
    if (that == null)
      return false;
  ...
  public int compareTo(Position3D other) {
    ...
    Position3D typedOther = (Position3D)other;
  ...
  private static class Position3DStandardSchemeFactory implements SchemeFactory {
    public Position3DStandardScheme getScheme() {
      return new Position3DStandardScheme();
    }
  }

  private static class Position3DStandardScheme extends StandardScheme<Position3D> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, Position3D struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Position3D struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class Position3DTupleSchemeFactory implements SchemeFactory {
    public Position3DTupleScheme getScheme() {
      return new Position3DTupleScheme();
    }
  }

  private static class Position3DTupleScheme extends TupleScheme<Position3D> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, Position3D struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, Position3D struct) throws org.apache.thrift.TException {
