...
//                       String bootClassPath) throws RunnerException {
  public boolean compile() throws SketchException {
    ...
    String baseCommand[] = new String[] {
      ...
      "-d", builder.getBinFolder().getAbsolutePath() // output the classes in the buildPath
    };
...
//      }
//    }
    String[] sourceFiles = Base.listFiles(builder.getSrcFolder(), false, ".java");
    ...
    try {
      ...
      */
      ...
      while ((line = reader.readLine()) != null) {
        ...
        exception = builder.placeException(errorMessage,
                                         dotJavaFilename,
                                         dotJavaLineIndex);
        /*
        int codeIndex = 0; //-1;
