...
public class HumanMotorManager extends MotorManager {
	...
	public HumanMotorManager(RobokoMain robokoMain, Robot robot) throws InstantiationException {
	...
	private void showCaptureFrame() {
		final RobokoMain robokoMain = getRobokoMain();
		if (kinect != null) {
			hideCaptureFrame();
		}
		try {
	...
	@Override
	protected CaptureFrameAbstractImpl newCaptureFrameInstance(RobokoMain robokoMain) {
