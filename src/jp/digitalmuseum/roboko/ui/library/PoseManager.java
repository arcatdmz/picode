...
import jp.digitalmuseum.roboko.ui.library.internal.IconListModel;
import jp.digitalmuseum.roboko.ui.library.internal.IconProvider;
...
public class PoseManager extends IconListModel<Pose> implements IconProvider {
	 ...
	 * @param robokoMain
	 */
	public PoseManager(RobokoMain robokoMain) {
		this.robokoMain = robokoMain;
		initialize();
	}

	private void initialize() {
		File poseFolder = new File(RobokoSettings.getPoseFolderPath());
